import { c as create_ssr_component, v as validate_component, e as escape, o as add_attribute, p as compute_rest_props, g as getContext, b as spread, d as escape_object, q as escape_attribute_value, t as createEventDispatcher, u as compute_slots, s as setContext, w as identity } from './ssr-Ideb-60o.js';
  ...
  do {
    ...
    $$rendered = `<main><div class="flex flex-col items-center justify-center">${validate_component(Alert, "Alert").$$render(
      $$result,
      {
        border: true,
        color: alertcolour,
        class: `mb-8 h-16 w-2/4 ${alertstatus}`
      },
      {},
      {
        icon: () => {
          return `${validate_component(InfoCircleSolid, "InfoCircleSolid").$$render($$result, { slot: "icon", class: "h-4 w-4" }, {}, {})}`;
        },
        default: () => {
          return `<span class="font-medium">${escape(alertheading)}</span> ${escape(alertmessage)}`;
        }
      }
    )} <div class="select-none pb-4 text-3xl font-semibold" data-svelte-h="svelte-1at4144">Bibendum PDF Parser</div> <div${add_attribute("class", `${UPLOADBOX} z-25 flex w-2/5 flex-col justify-center`, 0)}>${validate_component(Dropzone, "Dropzone").$$render(
      $$result,
      {
        id: "dropzone",
        inputClass: "p-4 ",
...
//# sourceMappingURL=_page.svelte-N7xEGrqf.js.map
