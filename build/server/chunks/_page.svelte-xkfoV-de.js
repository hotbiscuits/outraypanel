import { c as create_ssr_component, v as validate_component, f as compute_rest_props, i as add_attribute } from './ssr-c6zShGKQ.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="flex justify-center pb-8" data-svelte-h="svelte-1v9bbwb"><h1 class="h1 font-sans">Outrayjus Web Dashboard</h1></div> <div class="grid grid-cols-4 grid-rows-1 gap-4 pb-6 ">${validate_component(Card, "Card").$$render(
    ...
    {
      default: () => {
        return `${validate_component(TextPlaceholder, "TextPlaceholder").$$render($$result, { size: "sm", class: "w-72 h-16" }, {}, {})}`;
      }
    }
...
//# sourceMappingURL=_page.svelte-xkfoV-de.js.map
