...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<main><div class="flex flex-col items-center justify-center">${validate_component(Alert, "Alert").$$render(
      ...
      {}
    )}</div> <div class=""><button class="bg-slate-400/75 hover:bg-slate-600/75 text-gray-800 font-bold rounded-lg w-48 h-16 flex flex-row justify-center items-center transition duration-200"><svg${spread(
      [
        { xmlns: "http://www.w3.org/2000/svg" },
        { width: "1.5em" },
        { height: "1.5em" },
      ...
      {}
    )}><path fill="none" stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 20V10m0 10l4-4m-4 4l-4-4M4 4h16"></path></svg> <span class="mx-2" data-svelte-h="svelte-5a77kr">Download CSV</span></button></div> <a href="https://app.cartoncloud.com/Outrayjus/Parsers/uploadFile" target="_blank" class=""><button class="bg-slate-400/75 hover:bg-slate-600/75 text-gray-800 font-bold rounded-lg w-48 h-16 flex flex-row justify-center items-center transition duration-200"><svg${spread(
      [
        { xmlns: "http://www.w3.org/2000/svg" },
        { width: "1.5em" },
        { height: "1.5em" },
      ...
      {}
    )}><path fill="none" stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v10m0-10l4 4m-4-4l-4 4M4 4h16"></path></svg> <span class="mx-2" data-svelte-h="svelte-ldrr3v">CartonCloud</span></button></a></div></div></main>`;
  } while (!$$settled);
  return $$rendered;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-XYEzGINN.js.map
